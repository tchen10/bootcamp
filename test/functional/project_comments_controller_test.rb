...
class ProjectCommentsControllerTest < ActionController::TestCase
  ...
  test "should create project_comment" do
    assert_difference('ProjectComment.count') do
      post :create, project_comment: { post: @project_comment.post, project_id: @project_comment.project_id, user_id: @project_comment.user_id }
    end
  ...
  test "should update project_comment" do
    put :update, id: @project_comment, project_comment: { post: @project_comment.post, project_id: @project_comment.project_id, user_id: @project_comment.user_id }
    assert_redirected_to project_comment_path(assigns(:project_comment))
  end
